...
This would be equivalent of setting key PROP IN REACT (it is not but let's look it that way)

BUT WE ARE NOT SETTING key PROP, WE ARE ISOLATING WHAT SHOULD BE KEY IN EACH STATEMENT
